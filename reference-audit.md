# Audit du storefront de référence NORTICAM

Source visuelle : `https://3000-ie2180k11c3rfmphbssnj-3a5536d8.us4.manus.computer/`.

L’accueil est structuré comme une expérience de commerce automobile éditoriale. Une mince barre de promesse en haut précède une navigation blanche compacte avec le mot-symbole NORTICAM, quatre liens — Boutique, Comparatif, Trouver ma dashcam et Conseils — un CTA noir et un panier sous forme d’icône. Le hero bleu nuit oppose un message massif à gauche et une mise en scène de dashcam à droite. Son message est : « Chaque trajet mérite une preuve. » avec une emphase bleu électrique sur « une preuve. ».

Sous le hero, une bande blanche affiche trois réassurances à icône. Le flux principal passe ensuite à une surface blanc cassé : titre noir très large, rangée de cartes produits, puis un bloc sombre dédié aux cas d’usage. Il se poursuit avec un parcours de choix en trois étapes, une FAQ accordéon et un footer sombre.
